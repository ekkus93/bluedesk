...
class BootReceiver : BroadcastReceiver() {
    ...
    private suspend fun readSettings(context: Context): Settings? =
        try {
            ...
            DebugLog.e("BootReceiver", "settings read failed: ${e.message}")
            null
        }
    ...
    private fun applyDecision(
        ...
        when (decision) {
            ...
            is BootStartDecision.Skip -> DebugLog.e("BootReceiver", decision.reason)
        }
    }
    ...
    private fun startBackend(
        ...
        try {
            ...
            DebugLog.e("BootReceiver", "start ${cls.simpleName} failed: ${e.message}")
        }
    }
}
