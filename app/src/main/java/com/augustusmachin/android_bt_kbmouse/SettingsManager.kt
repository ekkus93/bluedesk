// Settings fields are documented with inline comments; keep them inline.
...
object SettingsManager {
    ...
    suspend fun setEnableHorizontalScroll(
        context: Context,
        v: Boolean,
    ) {
    ...
    suspend fun setInvertHorizontalScroll(
        context: Context,
        v: Boolean,
    ) {
    ...
    suspend fun setEnableMiddleClick(
        context: Context,
        v: Boolean,
    ) {
    ...
    suspend fun setDeviceTouchpadSensitivity(
        context: Context,
        addr: String,
        v: Float,
    ) {
    ...
    suspend fun setDeviceScrollSpeed(
        context: Context,
        addr: String,
        v: Float,
    ) {
    ...
    suspend fun setDeviceInvertScroll(
        context: Context,
        addr: String,
        v: Boolean,
    ) {
    ...
    suspend fun setDeviceEnableHorizontalScroll(
        context: Context,
        addr: String,
        v: Boolean,
    ) {
    ...
    suspend fun setDeviceInvertHorizontalScroll(
        context: Context,
        addr: String,
        v: Boolean,
    ) {
    ...
    suspend fun setDeviceEnableMiddleClick(
        context: Context,
        addr: String,
        v: Boolean,
    ) {
    ...
    suspend fun setDeviceKeyRepeatDelay(
        context: Context,
        addr: String,
        v: Int,
    ) {
    ...
    suspend fun setDeviceClickSound(
        context: Context,
        addr: String,
        v: Boolean,
    ) {
    ...
    suspend fun removeDeviceKeyRemap(
        context: Context,
        addr: String,
        fromUsage: Int,
    ) {
