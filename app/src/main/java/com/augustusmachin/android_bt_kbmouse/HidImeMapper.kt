...
fun charToHid(ch: Char): Pair<Byte, Int>? {
    ...
    val shifted =
        mapOf(
            '!' to Pair(0x1E, 0x02), '@' to Pair(0x1F, 0x02), '#' to Pair(0x20, 0x02), '$' to Pair(0x21, 0x02), '%' to Pair(0x22, 0x02),
            '^' to Pair(0x23, 0x02), '&' to Pair(0x24, 0x02), '*' to Pair(0x25, 0x02), '(' to Pair(0x26, 0x02), ')' to Pair(0x27, 0x02),
            '_' to Pair(0x2D, 0x02), '+' to Pair(0x2E, 0x02), '{' to Pair(0x2F, 0x02), '}' to Pair(0x30, 0x02), '|' to Pair(0x31, 0x02),
            '~' to Pair(0x35, 0x02), ':' to Pair(0x33, 0x02), '"' to Pair(0x34, 0x02), '<' to Pair(0x36, 0x02), '>' to Pair(0x37, 0x02),
            '?' to Pair(0x38, 0x02),
        )
